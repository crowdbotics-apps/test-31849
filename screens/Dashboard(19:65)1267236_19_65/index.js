...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_19_66}>
        <Text style={styles.Text_19_66}>Animal Wiki</Text>
      </View>
      <View style={styles.View_19_67}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3f0d/c0f2/b06bd96296783586330865a9d56c30cb"
          }}
          style={styles.ImageBackground_19_68}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_19_71}
        />
      </View>
      <View style={styles.View_19_75}>
        <View style={styles.View_19_76}>
          <View style={styles.View_19_77}>
            <Text style={styles.Text_19_77}>Popular</Text>
          </View>
        </View>
        <View style={styles.View_19_78}>
          <Text style={styles.Text_19_78}>Mammalians</Text>
        </View>
        <View style={styles.View_19_79}>
          <Text style={styles.Text_19_79}>Amphbians</Text>
        </View>
        <View style={styles.View_19_80}>
          <Text style={styles.Text_19_80}>Birds</Text>
        </View>
      </View>
      ...
      <View style={styles.View_19_82}>
        ...
        <View style={styles.View_19_84}>
          <Text style={styles.Text_19_84}>Mammalians</Text>
        </View>
        <View style={styles.View_19_85}>
          <Text style={styles.Text_19_85}>Lions</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_19_86}
        />
      </View>
      <View style={styles.View_19_87}>
        <View style={styles.View_19_88}>
          ...
          <ImageBackground
            ...
            style={styles.ImageBackground_19_90}
          />
        </View>
        <View style={styles.View_19_91}>
          <Text style={styles.Text_19_91}>Mammalians</Text>
        </View>
        <View style={styles.View_19_92}>
          <Text style={styles.Text_19_92}>Tiger</Text>
        </View>
      </View>
      <View style={styles.View_19_93}>
        <View style={styles.View_19_94} />
        <View style={styles.View_19_95}>
          <Text style={styles.Text_19_95}>Mammalians</Text>
        </View>
        <View style={styles.View_19_96}>
          <Text style={styles.Text_19_96}>Tortise</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_19_97}
        />
      </View>
      <View style={styles.View_19_98}>
        <View style={styles.View_19_99} />
        <View style={styles.View_19_100}>
          <Text style={styles.Text_19_100}>Mammalians</Text>
        </View>
        <View style={styles.View_19_101}>
          <Text style={styles.Text_19_101}>Elephant</Text>
        </View>
        <ImageBackground
          source={{
            uri:
